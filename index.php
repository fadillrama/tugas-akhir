...
<body>
		...
		<navbar class="navbar navbar-expand-lg navbar-dark bg-transparent">
			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
				<ul class="navbar-nav ml-auto mt-lg-3 mr-5 position-relative text-right">
					...
					<li class="nav-item">
					<a class="nav-link" href="surat/"><i class="fas fa-envelope"></i>&nbsp;BUAT SURAT</a>
					</li>
	...
	<div class="container" style="max-height:cover; padding-top:50px; padding-bottom:120px" align="center">
		<img src="assets/img/logo-kua-remove.png" width="25%">
		<hr>
		<a class="text-light" style="font-size:18pt"><strong>SISTEM INFORMASI PELAYANAN ADMINISTRASI PEMBUATAN SURAT</strong></a><br>
		<?php
		...
		?>
			<a class="text-light" style="font-size:15pt; text-transform: uppercase;"><strong>KECAMATAN <?php echo $row['kecamatan']; ?></strong><br>
				<a class="text-light" style="font-size:15pt; text-transform: uppercase;"><strong>KABUPATEN <?php echo $row['kota']; ?></strong></a>
				<hr>
			<?php
		}
			?>
	...
	<div class="footer bg-transparent text-center mb-3 ">
		<span class="text-light"><strong>Copyright &copy; 2023.</strong> All rights reserved.</span>
	</div>
</body>
