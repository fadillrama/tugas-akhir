                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" name="fdusun" class="form-control" style="text-transform: capitalize;" placeholder="Dusun" required>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" name="fkabupaten" class="form-control" style="text-transform: capitalize;" placeholder="Kota/Kabupaten" required>
                      </div>
                    </div>
                  </div>
                </div>
