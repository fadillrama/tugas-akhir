<?php 
	...
	for ($i=2; $i<=$jumlah_baris; $i++){
		...
		if($nik != "" && $nama != "" && $tempat_lahir != "" && $tgl_lahir != "" && $jenis_kelamin != "" && $agama != "" && $jalan != "" && $dusun != "" && $rt != "" && $rw != "" && $desa != "" && $kecamatan != "" && $kabupaten != "" && $no_kk != "" && $pend_kk != "" && $pend_terakhir != "" && $pend_ditempuh != "" && $pekerjaan != "" && $status_perkawinan != "" && $status_dlm_keluarga != "" && $kewarganegaraan != "" && $nama_ayah != "" && $nama_ibu != ""){
			mysqli_query($connect,"INSERT INTO penduduk VALUES(NULL, '$nik','$nama','$tempat_lahir','$tgl_lahir','$jenis_kelamin','$agama','$jalan','$dusun','$rt','$rw','$desa','$kecamatan','$kabupaten','$no_kk','$pend_kk','$pend_terakhir','$pend_ditempuh','$pekerjaan','$status_perkawinan','$status_dlm_keluarga','$kewarganegaraan','$nama_ayah','$nama_ibu')");
			$berhasil++;
		}
	}
