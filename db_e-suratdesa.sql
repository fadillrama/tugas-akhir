...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Mar 2023 pada 16.08
...
(1, 'Administrator', 'admin', 'admin@e-suratdesa.com', '827ccb0eea8a706c4c34a16891f84e7b', 'admin'),
(2, 'Kepala Desa', 'kades', 'kepaladesa@desa.id', '827ccb0eea8a706c4c34a16891f84e7b', 'kades'),
(3, 'Rama Fadillah', 'fadillrama', 'fadillahrama70@gmail.com', '25d55ad283aa400af464c76d713c07ad', 'admin');
...
INSERT INTO `penduduk` (`id_penduduk`, `nik`, `nama`, `tempat_lahir`, `tgl_lahir`, `jenis_kelamin`, `agama`, `jalan`, `dusun`, `rt`, `rw`, `desa`, `kecamatan`, `kabupaten`, `no_kk`, `pend_kk`, `pend_terakhir`, `pekerjaan`, `status_perkawinan`, `status_dlm_keluarga`, `kewarganegaraan`, `nama_ayah`, `nama_ibu`) VALUES
(92, '3517112233440001', 'Adi Fahrian Hidayat', 'jombang', '1997-12-14', 'Laki-laki', 'Islam', 'jl. KH. hasyim asy\'ari no. 15', 'Rawa Manggu', '001', '002', 'menturus', 'kudu', 'Ciamis', '3517000000000002', 'SLTA/SEDERAJAT', 'SLTA/SEDERAJAT', 'PELAJAR/MAHASISWA', 'Belum Menikah', 'Anak', 'WNI', 'Imam Haryono', 'Nasihah'),
(94, '360316110800001', 'Rajikh Burhanuddin Fath Abdul Jalil', 'tangerang', '2000-08-11', 'Laki-laki', 'Islam', 'Telaga Bumi Asri Blok B Nomer 5', 'Kidul', '001', '003', 'Mekar Kondang', 'Sukadiri', 'Kabupaten ', '232353235342', 'SLTA/SEDERAJAT', 'S1/SEDERAJAT', 'Pegawai Negeri Sipil', 'Belum Menikah', 'Anak', 'WNI', 'Sandi', 'Fajar'),
...
(1, 'MEKAR KONDANG', 'Jl. Lkr. SDN Tuis, Mekar Kondang, Kec. Sukadiri, Kabupaten Tangerang, Banten 15330', '082330827777', 'Panjalu', 'Ciamis', 'Jawa Barat', '46264');
...
(10, 'Surat Keterangan kehilangan', '089173654823', '3517112233440001', 'PACAR', '2022-01-25 15:01:56', 1, 'SELESAI', 1),
(11, 'Surat Keterangan kehilangan', '0123456789', '3517112233440001', 'PENGAJUAN FINANSIAL', '2023-02-15 20:42:28', 1, 'SELESAI', 1);
...
--
ALTER TABLE `surat_keterangan_kehilangan`
  MODIFY `id_skh` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
